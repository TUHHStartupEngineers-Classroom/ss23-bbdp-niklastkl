...
```{r}
# Bike data
bikes_tbl      <- readRDS(paste(rprojroot::find_rstudio_root_file(),"/01_data/bikes_tbl.rds", sep=""))
bikeshops_tbl  <- readRDS(paste(rprojroot::find_rstudio_root_file(),"/01_data/bikeshops_tbl.rds", sep=""))
orderlines_tbl <- readRDS(paste(rprojroot::find_rstudio_root_file(),"/01_data/orderlines_tbl.rds", sep=""))
