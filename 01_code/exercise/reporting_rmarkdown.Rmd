...
```{r}
# Bike data
bikes_tbl      <- readRDS(paste(rprojroot::find_rstudio_root_file(),"/data/bikes_tbl.rds", sep=""))
bikeshops_tbl  <- readRDS(paste(rprojroot::find_rstudio_root_file(),"/data/bikeshops_tbl.rds", sep=""))
orderlines_tbl <- readRDS(paste(rprojroot::find_rstudio_root_file(),"/data/orderlines_tbl.rds", sep=""))
